...
""" Example of deepstream using maskrcnn neural network and parsing mrcnn's outputs. """
...
from maskrcnn_parser import extract_maskrcnn_mask
import pyds
...
def build_pipeline_str(template:str = PIPELINE, **kw):
    return template.format_map(kw)
